...
class HuaweiModbusEmulator:
    ...
    def apply_values(self, items: dict[str, float | None]) -> None:
        ...
        # AC_mock = (PV + AC_real) / 2 — formula classica che ha funzionato
        # nei round 1-5 + notte + surplus alto mock (Grid=0 in tutti i casi).
        # Quando Grid e' grande (export forte live), serve indagine ulteriore.
        ...
        for addr, v_phase in (
            ...
            b.setValues(addr, R.i32(i_phase_centiA))
        # Per il live view, recupero il valore raw del current A/B/C
